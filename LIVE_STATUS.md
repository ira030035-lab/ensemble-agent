...
## Processes
```
root     2644105  0.0  1.0  55460 42800 ?        Ss   Aug04   0:09 /opt/ensemble-agent/venv/bin/python3 /opt/ensemble-agent/dashboard_api.py
root     2644107  0.0  1.1  58400 46144 ?        Ss   Aug04   0:00 /opt/ensemble-agent/venv/bin/python3 /opt/metla/dashboard_api.py
root     2644122  0.2  3.6 703876 141296 ?       Ssl  Aug04  33:36 /opt/ensemble-agent/venv/bin/python3 /opt/ensemble-agent/main.py
```
...
```
2026-08-14 08:59:51,308 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-14 08:59:51,627 [INFO] httpx: HTTP Request: POST https://api.anthropic.com/v1/messages "HTTP/1.1 400 Bad Request"
2026-08-14 08:59:51,628 [ERROR] agents: race fallback: Error code: 400 - {'type': 'error', 'error': {'type': 'invalid_request_error', 'message': 'Your credit balance is too low to access the Anthropic API. Please go to Plans & Billing to upgrade or purchase credits.'}, 'request_id': 'req_011Ce2NDtVnspLuqLFCmtGGS'}
2026-08-14 08:59:51,628 [WARNING] agents: Bear: unparseable response → flat/25. raw=
2026-08-14 08:59:51,628 [INFO] main: HYPEUSDT | Bull:flat(25%) Bear:flat(25%)
2026-08-14 08:59:51,864 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-14 08:59:51,865 [INFO] openai._base_client: Retrying request to /chat/completions in 0.385027 seconds
2026-08-14 08:59:52,455 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-14 08:59:52,456 [INFO] openai._base_client: Retrying request to /chat/completions in 0.892576 seconds
2026-08-14 08:59:53,949 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-14 08:59:53,951 [WARNING] agents: KimiJudge _claude failed: Error code: 429 - {'error': {'message': 'Your account org-b15d7af77d7b407d9d9f07f16a409e94 <ak-fabqohadqgu111dtsdp1> is suspended due to insufficient balance, please recharge your account or check your plan and billing details', 'type': 'exceeded_current_quota_error'}}
2026-08-14 08:59:53,951 [WARNING] agents: Judge JSON unparseable, defaulting to hold: 
2026-08-14 08:59:53,951 [INFO] main: HYPEUSDT | Judge:HOLD conf=50% size=0.0%
2026-08-14 08:59:53,951 [INFO] main: HYPEUSDT | RL adj=50.0%
2026-08-14 08:59:57,641 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-14 08:59:57,641 [INFO] openai._base_client: Retrying request to /chat/completions in 0.441189 seconds
2026-08-14 08:59:57,663 [INFO] httpx: HTTP Request: POST https://api.anthropic.com/v1/messages "HTTP/1.1 400 Bad Request"
2026-08-14 08:59:57,664 [ERROR] agents: race fallback: Error code: 400 - {'type': 'error', 'error': {'type': 'invalid_request_error', 'message': 'Your credit balance is too low to access the Anthropic API. Please go to Plans & Billing to upgrade or purchase credits.'}, 'request_id': 'req_011Ce2NELLoY61JEe74QuoMe'}
2026-08-14 08:59:57,664 [WARNING] agents: Bull: unparseable response → flat/25. raw=
2026-08-14 08:59:58,283 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-14 08:59:58,283 [INFO] openai._base_client: Retrying request to /chat/completions in 0.876651 seconds
2026-08-14 08:59:59,364 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-14 09:00:00,072 [INFO] httpx: HTTP Request: POST https://api.anthropic.com/v1/messages "HTTP/1.1 400 Bad Request"
2026-08-14 09:00:00,074 [ERROR] agents: race fallback: Error code: 400 - {'type': 'error', 'error': {'type': 'invalid_request_error', 'message': 'Your credit balance is too low to access the Anthropic API. Please go to Plans & Billing to upgrade or purchase credits.'}, 'request_id': 'req_011Ce2NEWffCAqPBE2XfysdS'}
2026-08-14 09:00:00,074 [WARNING] agents: Bear: unparseable response → flat/25. raw=
2026-08-14 09:00:00,074 [INFO] main: ENAUSDT | Bull:flat(25%) Bear:flat(25%)
2026-08-14 09:00:00,310 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-14 09:00:00,311 [INFO] openai._base_client: Retrying request to /chat/completions in 0.404679 seconds
2026-08-14 09:00:00,922 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-14 09:00:00,922 [INFO] openai._base_client: Retrying request to /chat/completions in 0.823066 seconds
```
...
Mem:           3.7Gi       935Mi       365Mi       4.4Mi       2.7Gi       2.8Gi
