...
root     2644122  0.2  3.3 693988 132120 ?       Ssl  Aug04   3:52 /opt/ensemble-agent/venv/bin/python3 /opt/ensemble-agent/main.py
```
...
```
2026-08-05 09:59:48,745 [INFO] main: BANKUSDT | Judge:HOLD conf=50% size=0.0%
2026-08-05 09:59:48,745 [INFO] main: BANKUSDT | RL adj=50.0%
2026-08-05 09:59:52,437 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-05 09:59:52,437 [INFO] openai._base_client: Retrying request to /chat/completions in 0.483691 seconds
2026-08-05 09:59:52,518 [INFO] httpx: HTTP Request: POST https://api.anthropic.com/v1/messages "HTTP/1.1 400 Bad Request"
2026-08-05 09:59:52,519 [ERROR] agents: race fallback: Error code: 400 - {'type': 'error', 'error': {'type': 'invalid_request_error', 'message': 'Your credit balance is too low to access the Anthropic API. Please go to Plans & Billing to upgrade or purchase credits.'}, 'request_id': 'req_011CdjQX5hNtbjHiCiDptvHD'}
2026-08-05 09:59:52,520 [WARNING] agents: Bull: unparseable response → flat/25. raw=
2026-08-05 09:59:53,126 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-05 09:59:53,127 [INFO] openai._base_client: Retrying request to /chat/completions in 0.787822 seconds
2026-08-05 09:59:54,120 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-05 09:59:54,379 [INFO] httpx: HTTP Request: POST https://api.anthropic.com/v1/messages "HTTP/1.1 400 Bad Request"
2026-08-05 09:59:54,380 [ERROR] agents: race fallback: Error code: 400 - {'type': 'error', 'error': {'type': 'invalid_request_error', 'message': 'Your credit balance is too low to access the Anthropic API. Please go to Plans & Billing to upgrade or purchase credits.'}, 'request_id': 'req_011CdjQXDyDRyLRZxX3yhvKK'}
2026-08-05 09:59:54,380 [WARNING] agents: Bear: unparseable response → flat/25. raw=
2026-08-05 09:59:54,380 [INFO] main: 1000RATSUSDT | Bull:flat(25%) Bear:flat(25%)
2026-08-05 09:59:54,625 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-05 09:59:54,626 [INFO] openai._base_client: Retrying request to /chat/completions in 0.377584 seconds
2026-08-05 09:59:55,213 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-05 09:59:55,213 [INFO] openai._base_client: Retrying request to /chat/completions in 0.857834 seconds
2026-08-05 09:59:56,277 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-05 09:59:56,277 [WARNING] agents: KimiJudge _claude failed: Error code: 429 - {'error': {'message': 'Your account org-b15d7af77d7b407d9d9f07f16a409e94 <ak-fabqohadqgu111dtsdp1> is suspended due to insufficient balance, please recharge your account or check your plan and billing details', 'type': 'exceeded_current_quota_error'}}
2026-08-05 09:59:56,277 [WARNING] agents: Judge JSON unparseable, defaulting to hold: 
2026-08-05 09:59:56,277 [INFO] main: 1000RATSUSDT | Judge:HOLD conf=50% size=0.0%
2026-08-05 09:59:56,278 [INFO] main: 1000RATSUSDT | RL adj=50.0%
2026-08-05 09:59:59,939 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-05 09:59:59,939 [INFO] openai._base_client: Retrying request to /chat/completions in 0.427338 seconds
2026-08-05 09:59:59,946 [INFO] httpx: HTTP Request: POST https://api.anthropic.com/v1/messages "HTTP/1.1 400 Bad Request"
2026-08-05 09:59:59,947 [ERROR] agents: race fallback: Error code: 400 - {'type': 'error', 'error': {'type': 'invalid_request_error', 'message': 'Your credit balance is too low to access the Anthropic API. Please go to Plans & Billing to upgrade or purchase credits.'}, 'request_id': 'req_011CdjQXdii9ufrN4opDUse9'}
2026-08-05 09:59:59,947 [WARNING] agents: Bull: unparseable response → flat/25. raw=
2026-08-05 10:00:00,574 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-05 10:00:00,574 [INFO] openai._base_client: Retrying request to /chat/completions in 0.986840 seconds
```
...
Mem:           3.7Gi       889Mi       311Mi       4.4Mi       2.8Gi       2.9Gi
