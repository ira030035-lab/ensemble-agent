...
## Processes
```
root      812670  0.0  1.2 209160 50548 ?        Ssl  May19   0:59 /opt/ensemble-agent/venv/bin/python3 /opt/ensemble-agent/dashboard_api.py
...
Mem:           3.7Gi       1.0Gi       547Mi       4.8Mi       2.5Gi       2.7Gi
Swap:             0B          0B          0B
```
