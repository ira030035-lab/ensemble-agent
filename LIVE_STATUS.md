...
root     2495722  0.2  3.5 700952 138968 ?       Ssl  Jul28  12:44 /opt/ensemble-agent/venv/bin/python3 /opt/ensemble-agent/main.py
```
...
```
2026-08-01 00:59:51,964 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-01 00:59:51,965 [INFO] openai._base_client: Retrying request to /chat/completions in 0.841019 seconds
2026-08-01 00:59:53,000 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-01 00:59:53,275 [INFO] httpx: HTTP Request: POST https://api.anthropic.com/v1/messages "HTTP/1.1 400 Bad Request"
2026-08-01 00:59:53,276 [ERROR] agents: race fallback: Error code: 400 - {'type': 'error', 'error': {'type': 'invalid_request_error', 'message': 'Your credit balance is too low to access the Anthropic API. Please go to Plans & Billing to upgrade or purchase credits.'}, 'request_id': 'req_011Cdb878i9CY3MDTWS9CKPw'}
2026-08-01 00:59:53,276 [WARNING] agents: Bear: unparseable response → flat/25. raw=
2026-08-01 00:59:53,276 [INFO] main: XRPUSDT | Bull:flat(25%) Bear:flat(25%)
2026-08-01 00:59:53,494 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-01 00:59:53,495 [INFO] openai._base_client: Retrying request to /chat/completions in 0.455343 seconds
2026-08-01 00:59:54,153 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-01 00:59:54,154 [INFO] openai._base_client: Retrying request to /chat/completions in 0.793433 seconds
2026-08-01 00:59:55,152 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-01 00:59:55,153 [WARNING] agents: KimiJudge _claude failed: Error code: 429 - {'error': {'message': 'Your account org-b15d7af77d7b407d9d9f07f16a409e94 <ak-fabqohadqgu111dtsdp1> is suspended due to insufficient balance, please recharge your account or check your plan and billing details', 'type': 'exceeded_current_quota_error'}}
2026-08-01 00:59:55,154 [WARNING] agents: Judge JSON unparseable, defaulting to hold: 
2026-08-01 00:59:55,154 [INFO] main: XRPUSDT | Judge:HOLD conf=50% size=0.0%
2026-08-01 00:59:55,154 [INFO] main: XRPUSDT | RL adj=50.0%
2026-08-01 00:59:58,786 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-01 00:59:58,787 [INFO] openai._base_client: Retrying request to /chat/completions in 0.435993 seconds
2026-08-01 00:59:59,041 [INFO] httpx: HTTP Request: POST https://api.anthropic.com/v1/messages "HTTP/1.1 400 Bad Request"
2026-08-01 00:59:59,042 [ERROR] agents: race fallback: Error code: 400 - {'type': 'error', 'error': {'type': 'invalid_request_error', 'message': 'Your credit balance is too low to access the Anthropic API. Please go to Plans & Billing to upgrade or purchase credits.'}, 'request_id': 'req_011Cdb87Z8pT9f42QL8oWuCU'}
2026-08-01 00:59:59,042 [WARNING] agents: Bull: unparseable response → flat/25. raw=
2026-08-01 00:59:59,419 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-01 00:59:59,419 [INFO] openai._base_client: Retrying request to /chat/completions in 0.782127 seconds
2026-08-01 01:00:00,398 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-01 01:00:00,645 [INFO] httpx: HTTP Request: POST https://api.anthropic.com/v1/messages "HTTP/1.1 400 Bad Request"
2026-08-01 01:00:00,647 [ERROR] agents: race fallback: Error code: 400 - {'type': 'error', 'error': {'type': 'invalid_request_error', 'message': 'Your credit balance is too low to access the Anthropic API. Please go to Plans & Billing to upgrade or purchase credits.'}, 'request_id': 'req_011Cdb87gLQu61NHfx4sSXUb'}
2026-08-01 01:00:00,647 [WARNING] agents: Bear: unparseable response → flat/25. raw=
2026-08-01 01:00:00,647 [INFO] main: NEARUSDT | Bull:flat(25%) Bear:flat(25%)
2026-08-01 01:00:00,858 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-01 01:00:00,859 [INFO] openai._base_client: Retrying request to /chat/completions in 0.475823 seconds
```
...
Mem:           3.7Gi       912Mi       248Mi       4.4Mi       2.9Gi       2.8Gi
