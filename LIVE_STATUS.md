...
Generated: 2026-08-10 01:20:01 UTC
...
root     2644107  0.0  1.0  55328 42204 ?        Ss   Aug04   0:00 /opt/ensemble-agent/venv/bin/python3 /opt/metla/dashboard_api.py
root     2644122  0.2  3.4 698244 136056 ?       Ssl  Aug04  18:57 /opt/ensemble-agent/venv/bin/python3 /opt/ensemble-agent/main.py
```
...
```
2026-08-10 00:49:52,228 [INFO] httpx: HTTP Request: POST https://api.anthropic.com/v1/messages "HTTP/1.1 400 Bad Request"
2026-08-10 00:49:52,229 [ERROR] agents: race fallback: Error code: 400 - {'type': 'error', 'error': {'type': 'invalid_request_error', 'message': 'Your credit balance is too low to access the Anthropic API. Please go to Plans & Billing to upgrade or purchase credits.'}, 'request_id': 'req_011Cdt9d52QC5tE7bZqfSEFD'}
2026-08-10 00:49:52,230 [WARNING] agents: Bull: unparseable response → flat/25. raw=
2026-08-10 00:49:52,836 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-10 00:49:52,837 [INFO] openai._base_client: Retrying request to /chat/completions in 0.940476 seconds
2026-08-10 00:49:53,977 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-10 00:49:54,255 [INFO] httpx: HTTP Request: POST https://api.anthropic.com/v1/messages "HTTP/1.1 400 Bad Request"
2026-08-10 00:49:54,256 [ERROR] agents: race fallback: Error code: 400 - {'type': 'error', 'error': {'type': 'invalid_request_error', 'message': 'Your credit balance is too low to access the Anthropic API. Please go to Plans & Billing to upgrade or purchase credits.'}, 'request_id': 'req_011Cdt9dDa6wZLL3LjccEyHp'}
2026-08-10 00:49:54,256 [WARNING] agents: Bear: unparseable response → flat/25. raw=
2026-08-10 00:49:54,256 [INFO] main: XRPUSDT | Bull:flat(25%) Bear:flat(25%)
2026-08-10 00:49:54,473 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-10 00:49:54,474 [INFO] openai._base_client: Retrying request to /chat/completions in 0.383682 seconds
2026-08-10 00:49:55,060 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-10 00:49:55,061 [INFO] openai._base_client: Retrying request to /chat/completions in 0.955565 seconds
2026-08-10 00:49:56,217 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-10 00:49:56,218 [WARNING] agents: KimiJudge _claude failed: Error code: 429 - {'error': {'message': 'Your account org-b15d7af77d7b407d9d9f07f16a409e94 <ak-fabqohadqgu111dtsdp1> is suspended due to insufficient balance, please recharge your account or check your plan and billing details', 'type': 'exceeded_current_quota_error'}}
2026-08-10 00:49:56,219 [WARNING] agents: Judge JSON unparseable, defaulting to hold: 
2026-08-10 00:49:56,219 [INFO] main: XRPUSDT | Judge:HOLD conf=50% size=0.0%
2026-08-10 00:49:56,219 [INFO] main: XRPUSDT | RL adj=50.0%
2026-08-10 00:49:58,222 [INFO] main: Next scan in 30min (always-30min)
2026-08-10 01:19:58,244 [INFO] main: Scanning 30 symbols...
2026-08-10 01:19:59,649 [WARNING] agents: Bull entropy-guard: шаблон detected. Используем Groq+Claude fallback.
2026-08-10 01:19:59,939 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-10 01:19:59,940 [INFO] openai._base_client: Retrying request to /chat/completions in 0.413263 seconds
2026-08-10 01:20:00,020 [INFO] httpx: HTTP Request: POST https://api.anthropic.com/v1/messages "HTTP/1.1 400 Bad Request"
2026-08-10 01:20:00,021 [ERROR] agents: race fallback: Error code: 400 - {'type': 'error', 'error': {'type': 'invalid_request_error', 'message': 'Your credit balance is too low to access the Anthropic API. Please go to Plans & Billing to upgrade or purchase credits.'}, 'request_id': 'req_011CdtBvKwJMpXuYbaZ3AwC3'}
2026-08-10 01:20:00,021 [WARNING] agents: Bull: unparseable response → flat/25. raw=
2026-08-10 01:20:00,554 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-10 01:20:00,555 [INFO] openai._base_client: Retrying request to /chat/completions in 0.942367 seconds
2026-08-10 01:20:01,713 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
```
...
Mem:           3.7Gi       907Mi       290Mi       4.4Mi       2.8Gi       2.8Gi
