...
## Processes
```
root     2495692  0.0  1.0  55468 42400 ?        Ss   Jul28   0:00 /opt/ensemble-agent/venv/bin/python3 /opt/ensemble-agent/dashboard_api.py
root     2495694  0.0  1.0  55208 42028 ?        Ss   Jul28   0:00 /opt/ensemble-agent/venv/bin/python3 /opt/metla/dashboard_api.py
root     2495722  0.2  3.5 698904 137512 ?       Ssl  Jul28   7:03 /opt/ensemble-agent/venv/bin/python3 /opt/ensemble-agent/main.py
```
...
```
2026-07-30 08:59:51,099 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-07-30 08:59:52,872 [INFO] httpx: HTTP Request: POST https://api.anthropic.com/v1/messages "HTTP/1.1 400 Bad Request"
2026-07-30 08:59:52,873 [ERROR] agents: race fallback: Error code: 400 - {'type': 'error', 'error': {'type': 'invalid_request_error', 'message': 'Your credit balance is too low to access the Anthropic API. Please go to Plans & Billing to upgrade or purchase credits.'}, 'request_id': 'req_011CdXy6EiTT3SHNXH5kk5Li'}
2026-07-30 08:59:52,873 [WARNING] agents: Bear: unparseable response → flat/25. raw=
2026-07-30 08:59:52,873 [INFO] main: ADAUSDT | Bull:flat(25%) Bear:flat(25%)
2026-07-30 08:59:53,102 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-07-30 08:59:53,102 [INFO] openai._base_client: Retrying request to /chat/completions in 0.494186 seconds
2026-07-30 08:59:53,805 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-07-30 08:59:53,806 [INFO] openai._base_client: Retrying request to /chat/completions in 0.840455 seconds
2026-07-30 08:59:54,853 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-07-30 08:59:54,854 [WARNING] agents: KimiJudge _claude failed: Error code: 429 - {'error': {'message': 'Your account org-b15d7af77d7b407d9d9f07f16a409e94 <ak-fabqohadqgu111dtsdp1> is suspended due to insufficient balance, please recharge your account or check your plan and billing details', 'type': 'exceeded_current_quota_error'}}
2026-07-30 08:59:54,854 [WARNING] agents: Judge JSON unparseable, defaulting to hold: 
2026-07-30 08:59:54,854 [INFO] main: ADAUSDT | Judge:HOLD conf=50% size=0.0%
2026-07-30 08:59:54,855 [INFO] main: ADAUSDT | RL adj=50.0%
2026-07-30 08:59:58,470 [INFO] httpx: HTTP Request: POST https://api.anthropic.com/v1/messages "HTTP/1.1 400 Bad Request"
2026-07-30 08:59:58,471 [ERROR] agents: race fallback: Error code: 400 - {'type': 'error', 'error': {'type': 'invalid_request_error', 'message': 'Your credit balance is too low to access the Anthropic API. Please go to Plans & Billing to upgrade or purchase credits.'}, 'request_id': 'req_011CdXy6fJZNpTTaS2zPoefU'}
2026-07-30 08:59:58,472 [WARNING] agents: Bull: unparseable response → flat/25. raw=
2026-07-30 08:59:58,518 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-07-30 08:59:58,519 [INFO] openai._base_client: Retrying request to /chat/completions in 0.393350 seconds
2026-07-30 08:59:59,116 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-07-30 08:59:59,117 [INFO] openai._base_client: Retrying request to /chat/completions in 0.760006 seconds
2026-07-30 09:00:00,088 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-07-30 09:00:00,344 [INFO] httpx: HTTP Request: POST https://api.anthropic.com/v1/messages "HTTP/1.1 400 Bad Request"
2026-07-30 09:00:00,345 [ERROR] agents: race fallback: Error code: 400 - {'type': 'error', 'error': {'type': 'invalid_request_error', 'message': 'Your credit balance is too low to access the Anthropic API. Please go to Plans & Billing to upgrade or purchase credits.'}, 'request_id': 'req_011CdXy6oA6WwMWwqELpF5kT'}
2026-07-30 09:00:00,345 [WARNING] agents: Bear: unparseable response → flat/25. raw=
2026-07-30 09:00:00,345 [INFO] main: SOLUSDT | Bull:flat(25%) Bear:flat(25%)
2026-07-30 09:00:00,584 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-07-30 09:00:00,585 [INFO] openai._base_client: Retrying request to /chat/completions in 0.459642 seconds
2026-07-30 09:00:01,269 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-07-30 09:00:01,270 [INFO] openai._base_client: Retrying request to /chat/completions in 0.815746 seconds
```
...
Mem:           3.7Gi       916Mi       331Mi       4.4Mi       2.8Gi       2.8Gi
