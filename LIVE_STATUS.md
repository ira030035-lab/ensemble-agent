...
root     2644122  0.2  3.3 693764 132116 ?       Ssl  Aug04   4:07 /opt/ensemble-agent/venv/bin/python3 /opt/ensemble-agent/main.py
```
...
```
2026-08-05 11:41:52,947 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-05 11:41:52,948 [INFO] openai._base_client: Retrying request to /chat/completions in 0.829104 seconds
2026-08-05 11:41:53,980 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-05 11:41:53,981 [WARNING] agents: KimiJudge _claude failed: Error code: 429 - {'error': {'message': 'Your account org-b15d7af77d7b407d9d9f07f16a409e94 <ak-fabqohadqgu111dtsdp1> is suspended due to insufficient balance, please recharge your account or check your plan and billing details', 'type': 'exceeded_current_quota_error'}}
2026-08-05 11:41:53,981 [WARNING] agents: Judge JSON unparseable, defaulting to hold: 
2026-08-05 11:41:53,981 [INFO] main: DOGEUSDT | Judge:HOLD conf=50% size=0.0%
2026-08-05 11:41:53,981 [INFO] main: DOGEUSDT | RL adj=50.0%
2026-08-05 11:41:57,420 [WARNING] agents: Bull entropy-guard: шаблон detected. Используем Groq+Claude fallback.
2026-08-05 11:41:57,635 [INFO] httpx: HTTP Request: POST https://api.anthropic.com/v1/messages "HTTP/1.1 400 Bad Request"
2026-08-05 11:41:57,636 [ERROR] agents: race fallback: Error code: 400 - {'type': 'error', 'error': {'type': 'invalid_request_error', 'message': 'Your credit balance is too low to access the Anthropic API. Please go to Plans & Billing to upgrade or purchase credits.'}, 'request_id': 'req_011CdjYJbaJNqyAbkBN1e8Jk'}
2026-08-05 11:41:57,636 [WARNING] agents: Bull: unparseable response → flat/25. raw=
2026-08-05 11:41:57,665 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-05 11:41:57,666 [INFO] openai._base_client: Retrying request to /chat/completions in 0.384587 seconds
2026-08-05 11:41:58,247 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-05 11:41:58,248 [INFO] openai._base_client: Retrying request to /chat/completions in 0.912976 seconds
2026-08-05 11:41:59,367 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-05 11:41:59,922 [INFO] httpx: HTTP Request: POST https://api.anthropic.com/v1/messages "HTTP/1.1 400 Bad Request"
2026-08-05 11:41:59,923 [ERROR] agents: race fallback: Error code: 400 - {'type': 'error', 'error': {'type': 'invalid_request_error', 'message': 'Your credit balance is too low to access the Anthropic API. Please go to Plans & Billing to upgrade or purchase credits.'}, 'request_id': 'req_011CdjYJm3Jwpu3NwyuWvJoi'}
2026-08-05 11:41:59,923 [WARNING] agents: Bear: unparseable response → flat/25. raw=
2026-08-05 11:41:59,924 [INFO] main: ADAUSDT | Bull:flat(25%) Bear:flat(25%)
2026-08-05 11:42:00,149 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-05 11:42:00,149 [INFO] openai._base_client: Retrying request to /chat/completions in 0.472132 seconds
2026-08-05 11:42:00,837 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-05 11:42:00,838 [INFO] openai._base_client: Retrying request to /chat/completions in 0.968776 seconds
2026-08-05 11:42:02,019 [INFO] httpx: HTTP Request: POST https://api.moonshot.ai/v1/chat/completions "HTTP/1.1 429 Too Many Requests"
2026-08-05 11:42:02,020 [WARNING] agents: KimiJudge _claude failed: Error code: 429 - {'error': {'message': 'Your account org-b15d7af77d7b407d9d9f07f16a409e94 <ak-fabqohadqgu111dtsdp1> is suspended due to insufficient balance, please recharge your account or check your plan and billing details', 'type': 'exceeded_current_quota_error'}}
2026-08-05 11:42:02,020 [WARNING] agents: Judge JSON unparseable, defaulting to hold: 
2026-08-05 11:42:02,020 [INFO] main: ADAUSDT | Judge:HOLD conf=50% size=0.0%
2026-08-05 11:42:02,020 [INFO] main: ADAUSDT | RL adj=50.0%
2026-08-05 11:42:04,023 [INFO] main: Next scan in 30min (always-30min)
```
...
Mem:           3.7Gi       904Mi       294Mi       4.4Mi       2.8Gi       2.8Gi
